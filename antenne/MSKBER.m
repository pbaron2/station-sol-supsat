...
Eb_N0_dB = [0:16]; % multiple Eb/N0 values
...
theoryBerbfsk = 0.5*erfc(sqrt(10.^(Eb_N0_dB/10)/2)); % theoretical ber

% plot
close all
figure
semilogy(Eb_N0_dB,theoryBerbfsk,'gs-','LineWidth',2);
hold on
...
axis([0 15 10^-10 0.5])
grid on
legend('theory - bfsk','theory - msk', 'simulation - msk');
xlabel('Eb/No, dB');
ylabel('Bit Error Rate');
title('Bit error probability curves for MSK and BFSK modulations');
